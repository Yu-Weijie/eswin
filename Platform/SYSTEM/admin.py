...
class Smoke(admin.ModelAdmin):
    # 设置页面可以展示的字段
    list_display = (
        'project', 'sub_project', 'level', 'preset_conditions', 'step', 'expected_results', 'is_execute', 'notes',
        'executor', 'auto', 'time')
    # 默认不配置的话，第一个字段会存在链接到记录编辑页面
    list_display_links = None
    # list_display_links = ('uid',)
    # 设置过滤选项
    list_filter = ('project', 'executor', 'is_execute', 'auto')
    # 每页显示条目数 缺省值100
    list_per_page = 15
...
@admin.register(WifiSta)
class WifiSta(admin.ModelAdmin):
    # 设置页面可以展示的字段
    list_display = (
        'number', 'category', 'project', 'sub_project', 'level', 'preset_conditions', 'step', 'expected_results',
        'is_execute', 'notes', 'executor', 'auto', 'time')
    # 默认不配置的话，第一个字段会存在链接到记录编辑页面
    list_display_links = None
    # list_display_links = ('uid',)
    # 设置过滤选项
    list_filter = ('number', 'category', 'project', 'level', 'is_execute', 'auto')
    # 每页显示条目数 缺省值100
    list_per_page = 15
    # show all页面上的model数目，缺省200
    list_max_show_all = 200
...
@admin.register(WifiDelay)
class WifiDelay(admin.ModelAdmin):
    # 设置页面可以展示的字段
    list_display = (
        'number', 'category', 'project', 'sub_project', 'level', 'preset_conditions', 'step', 'expected_results',
        'is_execute', 'notes', 'executor', 'auto', 'time')
...
@admin.register(WifiThroughPut)
class WifiThroughPut(admin.ModelAdmin):
    # 设置页面可以展示的字段
    list_display = (
        'number', 'category', 'project', 'sub_project', 'level', 'preset_conditions', 'step', 'expected_results',
        'is_execute', 'notes', 'executor', 'auto', 'time')
...
@admin.register(WifiFT)
class WifiFT(admin.ModelAdmin):
    # 设置页面可以展示的字段
    list_display = (
        'number', 'category', 'project', 'sub_project', 'level', 'preset_conditions', 'step', 'expected_results',
        'is_execute', 'notes', 'executor', 'auto', 'time')
...
@admin.register(BleMesh)
class BleMesh(admin.ModelAdmin):
    # 设置页面可以展示的字段
    list_display = (
        'number', 'category', 'project', 'sub_project', 'level', 'preset_conditions', 'step', 'expected_results',
        'is_execute', 'notes', 'executor', 'auto', 'time')
